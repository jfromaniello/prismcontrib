...
namespace CompositeWPFContrib.Composite.WindsorExtensions
{
    ...
    public static class WindsorContainerExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="TServiceType">The type of the interface.</typeparam>
        /// <typeparam name="TClassType">The type of the service.</typeparam>
        ...
        /// Registers the type on the container.
        /// </summary>
        /// <typeparam name="TServiceType">The type of interface.</typeparam>
        /// <typeparam name="TClassType">The type of the service.</typeparam>
        /// <param name="container">The container.</param>
